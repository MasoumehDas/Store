...
export class them {
  ...
  public selectedRowID: number | undefined;;
  public selectRow: boolean = false;
  public isMinSize: boolean = false;
  public loading: boolean = false;
  public DateEvent: NgbDateStruct | undefined;;
  ...
  public Lang: any = localStorage.getItem('language');
  public CompanyName: any = localStorage.getItem('CompanyName');
  ...
  //*******************************************************
  public parseNumber(num: any): string | null {
    return this.decimalPipe.transform(Number(num), '4.0-0') ?? '0';
  }
  ...
  public DeleteConfirm(selectedRowID:any) {


    if (this.selectRow == false) {
      this.SeupAlert(undefined, 'alert-warning');
  ...
  public DeleteRowConfirm(selectedRowID:any) {
  ...
  public SelectRow(postId: any, checked: boolean) {
    if (checked == true) {
      this.selectRow = true;
    }
    else {
  ...
  protected op = 1;
  protected id:any=undefined;

  public ShowAlert(alertID: any) {
  ...
  body: string = '';
  public SeupAlert(AlertLis: AlertForm|undefined, alertID: any) {
  ...
  public ToDate(dob: any): NgbDateStruct {
    if (dob) {
  ...
  public gregorian_to_jalali(gy: any, gm: any, gd: any) {
  ...
  public jalali_to_gregorian(jy: any, jm: any, jd: any) {
