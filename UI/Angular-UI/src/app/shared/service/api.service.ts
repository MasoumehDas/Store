...
import { BasicData,Basic } from '../../shared/modules/BasicData.module';
...
export class ConfigService {
  ...
  FetchBaseData_GroupType(Lang: string, UserName: string, GroupType: string, CodeChar: string) {
    ...
    return this.http.get<Basic[]>(this.configUrl, {
      params: {
        Lang: Lang,
        UserName: UserName,
        GroupType: GroupType,
  ...
  UpdateProductSpecification(params: any) {
  ...
  DeleteProductSpecification(Lang: string,ID :string, UserName: string) {
  ...
  //UpdateProductGroup---------------------------------------------------------------
  UpdateProductGroup(_params: any) {
    this.configUrl = this.configUrlBasic + '/UpdateProductGroup/Post'
    return this.http.post(this.configUrl, { _params }
    ).pipe(
      catchError(this.handleError)
    );
  }
  ...
  Fetch_FilterProductGroupDetailGet(UserName: string, Lang: string, ID: string, ProductGroupID: string,CompanyID:string) {
  ...
  Fetch_FilterProductGet(UserName: string, Lang: string, ID: string, CompanyID: string, ProductGroupID: string, BarCode: string, Name: string,
    IsAvailable:string,Acive:string,IsViewTelegram:string,IsViewInstagram:string,IsSendInstagram:string,IsSendTelegram:string,IsSpecialSales:string,Specification:string) {
  ...
  //Customer*********************************************************************
  Fetch_FilterCustomerGet(Lang: string, UserName: string, ID: string, CompanyID: string, Mobile: string, Email: string, FullName: string) {
  ...
  InsertOrder(params: any) {
    ...
    return this.http.post<Order[]>(this.configUrl, params
    ).pipe(
      catchError(this.handleError)
    );
  }
...
InsertCompanyTransportation(params: any) {
...
UpdateCompanyTransportation(params: any) {
...
DeleteCompanyTransportationID(ID :string,UserName: string,Lang :string) {
...
//--5:02:09 PM Friday, December 17, 2021
  //CompanyTransportation*********************************************************************
Fetch_FilterCompanyTransportationGet(Lang: string,UserName: string,CompanyID: string,TransportationCalculate_BasicData: string) {
    this.configUrl = this.configUrlBasic + '/SelectCompanyTransportation/Get'
    return this.http.get<CompanyTransportation[]>(this.configUrl, {
params: {
Lang:Lang,
UserName:UserName,
CompanyID:CompanyID,
...
Fetch_FilterCompanyTransportation(Lang: string, UserName: string) {
    this.configUrl = this.configUrlBasic + '/SelectCompanyTransportation/Get'
    return this.http.get<CompanyTransportation[]>(this.configUrl, {
 params: {
Lang: Lang,
...
Fetch_FilterCompanyTransportationID(Lang: string, UserName: string,ID :string) {
    this.configUrl = this.configUrlBasic + '/SelectCompanyTransportation/Get'
    return this.http.get<CompanyTransportation>(this.configUrl, {
 params: {
Lang: Lang,
