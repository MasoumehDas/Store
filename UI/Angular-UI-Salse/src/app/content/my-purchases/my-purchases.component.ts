...
export class MyPurchasesComponent implements OnInit {
  ...
  constructor(private productservice: ProductService, private configService: ConfigService, public titleService: Title, public them: them, public router: Router, private activatedRoute: ActivatedRoute) {
